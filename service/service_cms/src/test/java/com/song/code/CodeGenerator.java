...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\workplace\\guli_parent\\service\\service_cms" + "/src/main/java");
...
//        strategy.setTableFillList(tableFills);
        ...
        // 配置
        strategy.setInclude("crm_banner"); // 需要包含的表名，允许正则表达式（与exclude二选一配置）<br/>
