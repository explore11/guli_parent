...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\workplace\\guli_parent\\service\\service_sta" + "/src/main/java");
        ...
        pc.setModuleName("staservice"); // 父包模块名
...
//        strategy.setTableFillList(tableFills);
        ...
        // 配置
        strategy.setInclude("statistics_daily"); // 需要包含的表名，允许正则表达式（与exclude二选一配置）<br/>
