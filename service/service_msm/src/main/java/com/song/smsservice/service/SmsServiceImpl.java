...
import com.song.smsservice.utils.ConstantUtils;
...
public class SmsServiceImpl implements SmsService {
    ...
    @Override
    public boolean sendMessage(Map<String, String> params, String phone) {
        ...
        try {
            ...
            //必填:短信签名-可在短信控制台中找到
            request.setSignName("我的谷粒学院网站");
            //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
            request.setTemplateCode("SMS_202750248");
