...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("D:\\workplace\\guli_parent\\service\\service_order" + "/src/main/java");
        ...
        pc.setModuleName("eduorder"); // 父包模块名
...
//        strategy.setTableFillList(tableFills);
        ...
        // 配置
        strategy.setInclude("t_order", "t_pay_log"); // 需要包含的表名，允许正则表达式（与exclude二选一配置）<br/>
