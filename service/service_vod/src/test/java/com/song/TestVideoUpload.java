 ...
 * @description
 * @author: swq
 * @create: 2020-09-14 10:38
 **/
public class TestVideoUpload {
    public static void main(String[] args) {

        String accessKeyId = "LTAI4GJUXkVyr1abdhxoqiwX";
        String accessKeySecret = "InS0bT9nCWwh7sSecFz0ewj70xz1J3";

        String title = "测试视频";
        String fileName = "D:\\testvideo\\6 - What If I Want to Move Faster.mp4";
